...
Automatically generated by kaggle.

Original file is located at
    https://www.kaggle.com/code/jawadhasuna/jawadhassan-0035-ai-lab7-task-admissions
"""
...
model = joblib.load("Jawad Admission Predictor/admission_model.pkl")
...
# -----------------------------
# 📊 Normalize if your model was trained on a 1–10 scale
# -----------------------------
...
if st.button("Predict Admission Chance 🎯"):
    ...
    if prediction[0] == 1:
        st.success(f"✅ You are **likely to get admitted!** 🎉")
    else:
        st.error(f"❌ Admission is **less likely.** Try improving your profile!")
